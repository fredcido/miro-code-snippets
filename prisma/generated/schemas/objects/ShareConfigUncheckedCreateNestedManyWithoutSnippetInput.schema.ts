...
const Schema: z.ZodType<Prisma.ShareConfigUncheckedCreateNestedManyWithoutSnippetInput> =
  z
    .object({
      create: z
        .union([
...
export const ShareConfigUncheckedCreateNestedManyWithoutSnippetInputObjectSchema =
  Schema;
