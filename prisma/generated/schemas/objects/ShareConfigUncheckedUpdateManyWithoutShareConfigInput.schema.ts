...
const Schema: z.ZodType<Prisma.ShareConfigUncheckedUpdateManyWithoutShareConfigInput> =
  z
    .object({
      id: z
        .union([
...
export const ShareConfigUncheckedUpdateManyWithoutShareConfigInputObjectSchema =
  Schema;
