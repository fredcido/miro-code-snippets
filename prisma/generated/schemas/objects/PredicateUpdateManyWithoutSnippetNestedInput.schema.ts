...
const Schema: z.ZodType<Prisma.PredicateUpdateManyWithoutSnippetNestedInput> = z
  .object({
    create: z
      .union([
...
export const PredicateUpdateManyWithoutSnippetNestedInputObjectSchema = Schema;
