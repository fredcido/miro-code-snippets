...
const Schema: z.ZodType<Prisma.ShareConfigCreateNestedManyWithoutCreatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const ShareConfigCreateNestedManyWithoutCreatedByInputObjectSchema =
  Schema;
