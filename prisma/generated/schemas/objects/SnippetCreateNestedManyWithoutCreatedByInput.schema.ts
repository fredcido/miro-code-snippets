...
const Schema: z.ZodType<Prisma.SnippetCreateNestedManyWithoutCreatedByInput> = z
  .object({
    create: z
      .union([
...
export const SnippetCreateNestedManyWithoutCreatedByInputObjectSchema = Schema;
