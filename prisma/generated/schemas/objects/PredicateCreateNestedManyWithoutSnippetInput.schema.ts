...
const Schema: z.ZodType<Prisma.PredicateCreateNestedManyWithoutSnippetInput> = z
  .object({
    create: z
      .union([
...
export const PredicateCreateNestedManyWithoutSnippetInputObjectSchema = Schema;
