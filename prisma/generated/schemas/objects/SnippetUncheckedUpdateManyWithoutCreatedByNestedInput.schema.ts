...
const Schema: z.ZodType<Prisma.SnippetUncheckedUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SnippetUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;
