...
const Schema: z.ZodType<Prisma.ShareConfigUncheckedUpdateWithoutSnippetInput> =
  z
    .object({
      id: z
        .union([
...
export const ShareConfigUncheckedUpdateWithoutSnippetInputObjectSchema = Schema;
