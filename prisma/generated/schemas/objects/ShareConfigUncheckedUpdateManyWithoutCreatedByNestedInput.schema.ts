...
const Schema: z.ZodType<Prisma.ShareConfigUncheckedUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ShareConfigUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;
